...
<?php 
  include "Qr_code/JKRKBANK/qrlib.php";
  include "Qr_code/config.php";
...
<form method="POST">
<input type="text" name="cust_id" placeholder="Customer ID" value="<?php if(isset($_POST['create'])){ echo $_POST['customer_id']; } ?>" required><br>
