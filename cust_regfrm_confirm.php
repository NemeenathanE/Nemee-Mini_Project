...
<div class="cnfrm_info">
	 ...
	 <span><?php echo "Aadhar Number : ".$_SESSION['cust_aadhar']."<br>"; ?> </span>
	 ...
	 <span><?php echo "District : ".$_SESSION['cust_district']."<br>"; ?> </span>
	 <span><?php echo "Pin Code : ".$_SESSION['cust_pin']."<br>"; ?> </span>
	 <span><?php echo "City : ".$_SESSION['arealoc']."<br>"; ?> </span>
...
if(isset($_POST['cnfrm-submit'])){ 
	...
	$application_no = rand(100,9999).mt_rand(10000,99999);
	...
	$district=$_SESSION['cust_district'];
